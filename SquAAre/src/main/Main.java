		...
		do
		{
			...
			switch (option)
			{
				...
				case 3:
					...
					Manager aux1 = (Manager) getPersonByName(data.savedEmployee, auxName, auxSurname);
				...
				case 4:
					...
					Employee aux = (Employee) getPersonByName(data.savedEmployee, auxName, auxSurname);
				...
				case 6:
					actualBoss.logMessages.add("Usted cerró la sesión" + LocalDate.now().toString());
					try
					{
						data.pause(1);
					}
